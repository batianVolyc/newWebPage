module.exports = {
	...
	productHana: {
		...
		polygonMain: {
			text: "SAP S/4 HANA",
			detailText: ["简化数据模型", "§ 新的用户体验", "§ 高级处理", "§ 部署的选择"]
		},
		// 点击后的页面
		clickPage: {
	...
	productHanaCloud: {
		...
		ACimg1: require('../../assets/product/s4HanaCloud/zh-activationDetail1.png'),
		ENtitle: "实施方法",
		...
		explain: require("../../assets/product/s4HanaCloud/zh-explain.png"),
		transports: require("../../assets/product/s4HanaCloud/zh-transports.png"),
		notes: "从 Q → P 开始的和正在进行的运输"
	},
	// 线上教学资源
	online: {
		// 资产会计
		...
		Assets: {
			title: "资产会计",
			subTitle: ['主数据', '购置', '在建工程资本化', '公司代码内转移', '报废', '资产月结'],
			videoText1: "购置——有供应商购置（集成应付账款，无采购订单）",
			videoText2: "购置——过账购置（非集成）含自动抵消条目",
		},
		// 库存物料采购
		Inventory: {
			subList: ['创建采购申请', '直接创建采购订单', '供应商发票检验', '采购申请转换采购订单', '过账收货'],
			title: '库存物料采购',
			titleList: ['采购申请转换采购订单', '过账收货', '创建采购申请', '直接创建采购订单', '供应商发票校检验']
		}
	},
	// 教育培训解决方案
	eduScheme: {
