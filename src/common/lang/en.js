module.exports = {
	...
	productHana: {
		...
		polygonMain: {
			text: "SAP S/4 HANA",
			detailText: ["Simplified data model", "§ New user experience", "§ Advanced processing", "§ Choice of deployment"]
		},
		// 点击后的页面
		clickPage: {
	...
	productHanaCloud: {
		...
		ACimg1: require('../../assets/product/s4HanaCloud/en-activationDetail1.png'),
		ENtitle: "Implementation Methodology",
		ENimg: require('../../assets/product/s4HanaCloud/en-methodOfImplementationBW.png'),
		milestoneList: [{
				title: "Milestone 1",
				detail: '"Scoping finished"',
			},
			{
				title: "Milestone 2",
				detail: '"Explore finished" triggers the initial deployment',
			},
			{
				title: "Milestone 3",
				detail: '"Realize finished" triggers the start of the Deploy phase',
			},
			{
				title: "Milestone 4",
				detail: '"Confirm go-live" closes the implementation project',
			}
		],
		activityList: [{
			title: "Activity",
			detail: 'request Q and P system',
		}, {
			title: "Activity",
			detail: 'triggers the transports from Q → P',
		}],
		explain: require("../../assets/product/s4HanaCloud/en-explain.png"),
		transports: require("../../assets/product/s4HanaCloud/en-transports.png"),
		notes: "Initial and ongoing transports from Q→P"
	},
	// 线上教学资源
	online: {
		// 资产会计
		...
		Assets: {
			...
			subTitle: ['Master data', 'Purchase', 'Capitalization of construction in progress', 'Intra-company code transfer',
				'Scrapping', 'Monthly statement of assets'
			],
			videoText1: "PURCHASE -- Foshan with vendor purchase (integrated accounts payable, no purchase order)",
			videoText2: "PURCHASE -- over-the-counter purchase (non-integrated) includes an auto-cancellation entry"
		},
		// 库存物料采购
		Inventory: {
			subList: ['Create a purchase request', 'Create purchase orders directly', 'Supplier invoice inspection',
				'Purchase requisition conversion purchase order', 'Posting receipt'
			],
			title: 'Stock purchase',
			titleList: ['Purchase requisition conversion purchase order', 'Posting receipt', 'Create a purchase request',
				'Create purchase orders directly', 'Supplier invoice inspection'
			]
		}
	},
	// 教育培训解决方案
